...
public:
	const char *GetName(unsigned int vguiPanel)
	{
		...
		return Call_从数组中取地址调用CALL<OriginalFn>(this, Offsets::VMT::Panel_GetName)(this, vguiPanel);
	}
};
...
public:
	...
	CUserCmd* GetUserCmd(int slot, int seq)
	{
		...
		return Call_从数组中取地址调用CALL<OriginalFn>(this, 9)(this, slot, seq);
	}
};
...
public:
	int	GetPointContents(const Vector &vecAbsPosition, int contentsMask = MASK_ALL, IClientEntity** ppEntity = NULL)
	{
		...
		return Call_从数组中取地址调用CALL<fnGetPointContents>(this, 0)(this, vecAbsPosition, contentsMask, ppEntity);
	}

	void TraceRay(const Ray_t &ray, unsigned int fMask, ITraceFilter* pTraceFilter, trace_t* pTrace)
	{
		typedef void(__thiscall* fnTraceRay)(void*, const Ray_t&, unsigned int, ITraceFilter*, trace_t*);
		Call_从数组中取地址调用CALL<fnTraceRay>(this, 5)(this, ray, fMask, pTraceFilter, pTrace);
	}
	void EdgeTraceRay(Ray_t &ray, CTraceFilter &filt, CGameTrace &trace, bool wall = false) 
	{
		...
		Call_从数组中取地址调用CALL<OrigFn>(this, 5)(this, ray, wall ? 0x200400B : 0x46004003, filt, trace);				// 0x46004003 0x4600400B
	}
};
...
public:
	...
	surfacedata_t	*GetSurfaceData(int surfaceDataIndex)
	{
		...
		return Call_从数组中取地址调用CALL<fnGetSurfaceData>(this, 5)(this, surfaceDataIndex);
	}
};
...
public:
	...
	void const ConsoleColorPrintf(const Color& clr, const char *pFormat, ...)
	{
		...
		Call_从数组中取地址调用CALL<OriginalFn>(this, 25)(this, clr, buf, list);
	}
};
...
public:
	dlight_t* CL_AllocDlight(int key)
	{
		...
		return Call_从数组中取地址调用CALL<OriginalFn>(this, 4)(this, key);
	}
	dlight_t* CL_AllocElight(int key)
	{
		typedef dlight_t*(__thiscall* OriginalFn)(PVOID, int);
		return Call_从数组中取地址调用CALL<OriginalFn>(this, 5)(this, key);
	}
	dlight_t* GetElightByKey(int key)
	{
		typedef dlight_t*(__thiscall* OriginalFn)(PVOID, int);
		return Call_从数组中取地址调用CALL<OriginalFn>(this, 8)(this, key);
	}
};
////////NEU ENDE///////
