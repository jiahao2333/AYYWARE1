...
void Interfaces::Initialise()
{
	...
	char* EngineRenderViewInterface = (char*)Utilities::内存操作::查找内存_文本型("client.dll", "VEngineRenderView0");
	...
	Globals = **reinterpret_cast<CGlobalVarsBase***>(Utilities::内存操作::查找内存_文本型W("client.dll", "A1 ? ? ? ? 5E 8B 40 10") + 1);
