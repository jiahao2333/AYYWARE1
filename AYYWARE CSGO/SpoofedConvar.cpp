...
void ConVar::SetValue(const char* value)
{
	...
	return  Call_从数组中取地址调用CALL<OriginalFn>(this, 14)(this, value);
}

void ConVar::SetValue(float value)
{
	typedef void(__thiscall* OriginalFn)(void*, float);
	return Call_从数组中取地址调用CALL<OriginalFn>(this, 15)(this, value);
}

void ConVar::SetValue(int value)
{
	typedef void(__thiscall* OriginalFn)(void*, int);
	return Call_从数组中取地址调用CALL<OriginalFn>(this, 16)(this, value);
}
...
void ConVar::SetValue(Color value)
{
	...
	return Call_从数组中取地址调用CALL<OriginalFn>(this, 17)(this, value);
}

char* ConVar::GetName()
{
	typedef char*(__thiscall* OriginalFn)(void*);
	return Call_从数组中取地址调用CALL<OriginalFn>(this, 5)(this);
}
